...
<div class="wrapper">
  ...
  <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form method="POST" action="components/do/store/do-input-store.php">
                  <div class="row">
                    <div class="col-sm-12">
                      <!-- text input -->
                      <div class="form-group">
                        <label>Store Address</label>
                        <textarea class="form-control" rows="3" name="store_address" placeholder="Enter ..."></textarea>
                      </div>
                    </div>
                    </div>
                      <div class="form-group">
                        <label>Store Phone Number</label>
                        <input type="text" class="form-control" name="store_phone_number" placeholder="Enter ...">
                      </div>
                  </div>
