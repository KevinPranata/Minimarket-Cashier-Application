...
<div class="wrapper">
  ...
  <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form method="POST" action="components/do/customer/do-input-customer.php">
                  <div class="row">
                    <div class="col-sm-12">
                      <!-- text input -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="customer_gender" value="Female">
                          <label class="form-check-label">Female</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label>Customer Phone Number</label>
                        <input type="text" class="form-control" name="customer_phone_number" placeholder="Enter ...">
                      </div>
                      <div class="form-group">
