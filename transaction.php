...
<div class="wrapper">
  ...
  <div class="card">
              ...
              <div class="card-body">
                ...
                <a type="button" href="transaction-input.php" class="btn btn-block bg-gradient-success">TAMBAH DATA BARU</a>
                  <thead>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><?php echo date_format($data['TransactionDate'],'Y-m-d'); ?></td>
                  </tr>
                  <?php } ?>
                  </tbody>
                  <tfoot>
